...
\begin{figure}
  ...
  \caption{One period of a smooth sawtooth function as a sum of three piecewise functions.}
  \label{fig:ssaw}
\end{figure}
...
\noindent Considering both pieces of advice as well as the fact that my computer, a 2.5 GHz Intel Core i5, 13-inch, Mid-2012 MacBook Pro, has an L2-Cache size of 256 KB, it was decided that a Wavetable size of 4096, which translates to 32 KB of memory, would be suitable.\\
